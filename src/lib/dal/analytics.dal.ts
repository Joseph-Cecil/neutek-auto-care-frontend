...
import type {
  ApiResponse, DashboardStats, RevenuePeriod, JobsByStatus,
  TopService, TechnicianPerformance, RevenueParams,
} from '@/lib/dto';
...
export const analyticsDal = {
  ...
  getTopServices:           (limit = 10) =>
    apiClient.get<ApiResponse<TopService[]>>(ENDPOINTS.ANALYTICS.SERVICES, { params: { limit } }),
