...
import { Menu, Bell, LogOut, User, Zap, ExternalLink } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center gap-4 border-b border-border bg-card/80 px-4 backdrop-blur-md lg:px-6">
      ...
      <Link href="/portal/dashboard">
        <Button variant="ghost" size="sm" className="hidden items-center gap-1.5 text-muted-foreground sm:flex">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-52">
          <DropdownMenuLabel>
            ...
            <p className="text-xs font-normal capitalize text-muted-foreground">{user?.role}</p>
          </DropdownMenuLabel>
