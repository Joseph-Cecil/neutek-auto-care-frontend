// ─────────────────────────────────────────────────────────────
// Neutek Auto Care — Navigation Config
// Role-based navigation for portal and admin
// ─────────────────────────────────────────────────────────────
import {
  LayoutDashboard, Car, Wrench, FileText, Receipt,
  Bell, User, Users, Calendar, BarChart3, Settings,
  Package, Building2, BookOpen, CreditCard, Shield,
  ClipboardList,
} from 'lucide-react';
...
export const adminNavigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Reports',   href: '/admin/analytics', icon: ClipboardList },
    ],
  },
  {
    title: 'System',
